            ...
            <table class="table teacher-table">
                ...
                <?php foreach ($teachers as $username => $teacher): ?>
                    ...
                    <tr class="teacher-row" data-search="<?php echo htmlspecialchars($searchText); ?>" data-subjects="<?php echo htmlspecialchars(implode(',', $assignedSubjectIds)); ?>" data-grades="<?php echo htmlspecialchars(implode(',', $assignedGrades)); ?>" data-status="<?php echo $isComplete ? 'complete' : 'incomplete'; ?>">
                        ...
                        <td class="text-end teacher-actions"><div class="dropdown"><button class="btn btn-outline-secondary btn-sm dropdown-toggle" data-bs-toggle="dropdown" data-bs-popper-config='{"strategy":"fixed"}' aria-label="Mở thao tác"><i class="bi bi-three-dots-vertical"></i></button><ul class="dropdown-menu dropdown-menu-end">
...
document.querySelectorAll('.teacher-actions .dropdown-toggle').forEach(el => {
